      ...
      <section className="pt-36 pb-16 px-6 lg:px-12 relative overflow-hidden">
        <div className="max-w-screen-xl mx-auto relative z-10">
          <div className="flex items-center gap-3 mb-6">
            <span className="font-mono text-signal text-[0.65rem] tracking-[0.3em] uppercase">Contact</span>
      ...
      <section className="pb-24 px-6 lg:px-12">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="flex flex-col items-start gap-6 py-12">
                <div className="w-12 h-12 border border-signal/40 flex items-center justify-center">
                  <span className="font-mono text-signal text-xl">✓</span>
                </div>
                <div>
                  ...
                  <p className="text-smoke-dim text-base" style={{ fontWeight: 300 }}>
                    ...
                    <a href="/blog" className="text-signal hover:text-signal transition-colors">notes</a>.
                  </p>
                </div>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div className="font-mono text-[0.65rem] tracking-[0.3em] uppercase text-signal mb-2">
                  &gt; send_message --init
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      className="w-full bg-ink-2 border border-white/10 focus:border-signal/50 text-smoke px-4 py-3 font-mono text-sm outline-none transition-colors"
                      type="text"
                ...
                <div>
                  ...
                  <select
                    className="w-full bg-ink-2 border border-white/10 focus:border-signal/50 text-smoke-dim px-4 py-3 font-mono text-sm outline-none transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    className="w-full bg-ink-2 border border-white/10 focus:border-signal/50 text-smoke px-4 py-3 font-mono text-sm outline-none transition-colors resize-none"
                    rows={6}
                ...
                <div>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="font-mono text-[0.7rem] tracking-widest uppercase px-6 py-3 bg-signal text-ink hover:bg-signal disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            <div>
              <p className="font-mono text-[0.6rem] tracking-[0.2em] uppercase text-signal mb-4">Response time</p>
            ...
            <div>
              <p className="font-mono text-[0.6rem] tracking-[0.2em] uppercase text-signal mb-4">Profiles</p>
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <a
                    ...
                    className="font-mono text-[0.65rem] tracking-wider uppercase text-smoke-faint hover:text-signal transition-colors"
                  >
                    {label} ↗
                  </a>
                ))}
